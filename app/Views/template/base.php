...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url();?>/public/assets/css/bootstrap-float-label.css">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <?php if(loggediIn()):?>
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?= base_url();?>/user/<?= session()->get('user')['id'];?>/profile">Profile</a>
            </li>
          <?php else:?>
            <li class="nav-item">
